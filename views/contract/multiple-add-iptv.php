...
$this->title = Yii::t('app', 'Добавление учетных записей IPTV для договоров bgbilling');
...
<?php if($info) { ?>
	<div class="alert alert-info">
		<strong>Info for site Administrator!</strong> 
        <?= Html::label('Активных договоров в bg billing '.count($items),'', ['style'=>'width:300px;',]); ?>
        <?= Html::label($message, ['style'=>'width:300px;',]); ?>
	</div>
<?php } ?>
